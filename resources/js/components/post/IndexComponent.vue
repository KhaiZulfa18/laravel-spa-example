                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tr v-for="(post, index) in posts" :key="post.id">
                                    ...
                                    <td class="text-center">
                                        <router-link :to="{name: 'post.show', params: { id: post.id }}" class="btn btn-sm btn-primary">Show</router-link>
                                        <router-link :to="{name: 'post.edit', params: { id: post.id }}" class="btn btn-sm btn-info">Edit</router-link>
                                        <button @click.prevent="PostDelete(post.id, index)" class="btn btn-sm btn-danger">Delete</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
